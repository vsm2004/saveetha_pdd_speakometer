package com.simats.speakometerfrontend.network
...
interface VoiceApiService {
    ...
    // GET User Profile for background sync
    @GET("api/profile")
    suspend fun getProfile(@retrofit2.http.Query("user_id") userId: Int): Response<ProfileSyncResponse>
