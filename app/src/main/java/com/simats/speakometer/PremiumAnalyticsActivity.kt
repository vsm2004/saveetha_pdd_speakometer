...
class PremiumAnalyticsActivity : AppCompatActivity() {
    ...
    private var userSessions: List<com.simats.speakometer.network.SessionData> = emptyList()

    private fun updateDynamicAnalytics(sessions: List<com.simats.speakometer.network.SessionData>) {
